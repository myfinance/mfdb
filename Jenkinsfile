 ...
 stages{
   ...
   stage('deploy to Cluster'){
     ...
     steps {
       ...
       sh 'helm install mfdb ./helm/mfdb/ -n ${TEST_NAMESPACE} --set repository=${DOCKER_REPO}${DOCKERHUB_USER}/${ORGANIZATION_NAME}- --set stage=test --set mfdb.db_url=${K8N_IP} --set mfdb.db_port_ext=30024'
